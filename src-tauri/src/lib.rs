...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let user_style_root=app.path().app_local_data_dir()?.join("trained-styles");
            trained_styles.load_additional_style_root(&user_style_root)?;
            let training=Arc::new(photo_core::training::TrainingService::new(service.repository.clone(),analysis.clone(),engine.clone(),user_style_root,cache.join("training-v1"))?);
            ...
            app.manage(DesktopState(Arc::new(service),Arc::new(development),analysis,Arc::new(culling),batch_context,trained_styles,training));
            tracing::info!(target: "application", "Desktop foundation initialized");
            Ok(())
        })
        .invoke_handler(tauri::generate_handler![commands::match_validate_training_dataset,commands::training_matching_progress,commands::cancel_training_matching,commands::list_jobs, commands::get_job, commands::create_job, commands::resume_job, commands::list_assets, commands::get_thumbnail, commands::machine_resources, commands::photo_formats, commands::list_warnings,commands::get_development,commands::save_development,commands::render_development,commands::cancel_development,commands::development_mask,commands::save_recipe,commands::render_recipe,commands::recipe_mask,commands::recipe_history,commands::restore_recipe,commands::recipe_diff,commands::export_recipe,commands::import_recipe,commands::recipe_json,commands::get_analysis,commands::analyze_asset,commands::cancel_analysis,commands::invalidate_analysis,commands::export_analysis,commands::run_culling,commands::cancel_culling,commands::culling_progress,commands::culling_overview,commands::culling_detail,commands::culling_rating,commands::culling_select_asset,commands::culling_select_assets,commands::culling_select_ratings,commands::run_batch_context,commands::batch_context_state,commands::batch_context_progress,commands::cancel_batch_context,commands::builtin_presets,commands::preset_editing_state,commands::apply_builtin_preset,commands::trained_styles,commands::trained_style_state,commands::apply_trained_style,commands::trained_style_progress,commands::cancel_trained_style,commands::training_datasets,commands::create_training_dataset,commands::training_dataset,commands::add_training_pair,commands::add_training_before_files,commands::add_training_after_files,commands::add_training_before_folder,commands::add_training_after_folder,commands::add_training_path_pair,commands::match_training_dataset,commands::auto_match_training_folder,commands::set_training_pair_excluded,commands::validate_training_dataset,commands::run_training,commands::training_progress,commands::cancel_training,commands::training_pair_previews,commands::training_feedback,commands::prepare_training_validation])
