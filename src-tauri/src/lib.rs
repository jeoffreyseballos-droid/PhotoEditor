...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let batch_context=photo_core::batch_context::BatchContextService::new(service.repository.clone(),analysis.clone());
            ...
            app.manage(DesktopState(Arc::new(service),Arc::new(development),analysis,Arc::new(culling),Arc::new(batch_context)));
