...
The development package is a regression fixture, not a claim to reproduce a photographer's taste. Phase 8 training (RAW/reference pairing, optimization, feedback learning, style authoring UI and cloud training) is intentionally out of scope. CPU inference is lightweight, but real-photo quality, broad camera coverage, GPU acceleration, signing/licensing and macOS runtime acceptance remain open.
